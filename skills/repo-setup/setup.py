...
Templates are copied from ~/.claude/skills/repo-setup/templates/

Usage: python3 ~/.claude/skills/repo-setup/setup.py [project_path]
"""
...
TEMPLATE_DIR = CLAUDE_DIR / "skills" / "repo-setup" / "templates"
