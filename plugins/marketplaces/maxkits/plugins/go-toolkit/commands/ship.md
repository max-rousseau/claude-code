---
description: Full pre-deployment pipeline for Go - security, quality, tests, commit, PR creation, CI/CD monitoring, and post-merge cleanup.
---
...
# SHIP COMMAND - Go Pre-Deployment Pipeline

You are orchestrating the complete ship process for a Go project. This is a sequential pipeline where each phase must complete successfully before proceeding.
